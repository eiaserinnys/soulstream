...
# 결과 스택: SPAFallbackMiddleware → CheckDrainingMiddleware → CORSMiddleware → Router
from soul_server.middleware import CheckDrainingMiddleware, SPAFallbackMiddleware

app.add_middleware(CheckDrainingMiddleware, is_draining_fn=lambda: _is_draining)
