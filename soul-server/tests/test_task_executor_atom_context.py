"""_format_atom_context 단위 테스트"""
import pytest
from soul_server.service.task_executor import _format_atom_context, _ATOM_CONTEXT_HEADER


class TestFormatAtomContext:
    def test_header_prepended(self):
        """헤더 줄이 첫 번째 줄에 포함된다."""
        result = _format_atom_context(
