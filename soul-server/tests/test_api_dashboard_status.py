...
def client_no_auth():
    ...
    with (
        patch("soul_server.dashboard.routes.sessions._status.get_task_manager", return_value=mock_task_manager),
        patch("soul_server.dashboard.routes.sessions._status.get_session_query_service", return_value=mock_query_service),
        patch("soul_server.dashboard.routes.sessions._status.resource_manager", mock_resource_manager),
    ):
