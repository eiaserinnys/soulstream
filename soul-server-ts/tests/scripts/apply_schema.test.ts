    ...
    async () => {
      ...
      try {
        ...
        expect(promoted).toEqual([
          ...
          {
            migration_id: "065_completion_terminal_revision_fence.sql",
            ordinal: 66,
            applied_kind: "migration",
          },
          {
            migration_id: "066_session_delivery_enqueue_sequence.sql",
            ordinal: 67,
            applied_kind: "migration",
          },
          {
            migration_id: "067_execution_ownership_delivery_convergence.sql",
            ordinal: 68,
            applied_kind: "migration",
          },
          {
            migration_id: "068_execution_owner_recovery_singleflight.sql",
            ordinal: 69,
            applied_kind: "migration",
          },
          {
          ...
          {
            migration_id: "071_execution_dead_owner_expiry.sql",
            ordinal: 72,
            applied_kind: "migration",
          },
          {
            migration_id: "072_owner_null_backfill_identity_guard.sql",
            ordinal: 73,
            applied_kind: "migration",
          },
          {
            migration_id: "073_sessions_execution_owner_v1.sql",
            ordinal: 74,
            applied_kind: "migration",
          },
          {
            migration_id: "074_sessions_execution_owner_renew.sql",
            ordinal: 75,
            applied_kind: "migration",
          },
          {
          ...
          {
            migration_id: "077_ownerless_terminal_stale_event_cas.sql",
            ordinal: 78,
            applied_kind: "migration",
          },
          {
            migration_id: "078_terminal_execution_ownership_retirement.sql",
            ordinal: 79,
            applied_kind: "migration",
          },
