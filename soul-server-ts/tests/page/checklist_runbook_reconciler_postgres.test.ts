...
import { ChecklistRunbookAdapter } from "../../src/page/checklist_runbook_adapter.js";
import { ChecklistRunbookReconciler } from "../../src/page/checklist_runbook_reconciler.js";
...
describePostgres("checklist production projection PostgreSQL integration", () => {
  ...
  beforeEach(async () => {
    ...
    service = new RunbookService(
      db,
      { emitRunbookUpdated: vi.fn(async () => undefined) },
      boardYjsService,
  ...
  function createReconciler(
    ...
    return composeChecklistRunbookProjection({
      nodeId: "node-1",
      db,
