...
export const REQUIRED_RUNTIME_MIGRATIONS: readonly RequiredRuntimeMigration[] = [
  ...
  {
    ordinal: 51,
    migrationId: "050_session_id_search_indexed.sql",
    checksum: "e73726885750516d97685aa9f8df470b818bbd2c13e1bbdcac5f1ec4ed4ab9e6",
  },
  {
    ordinal: 52,
    migrationId: "051_session_digests.sql",
    checksum: "683e16b59550227d16fc994a52911cd5344e83f7d7047fa232c022fae4c8228e",
  },
  {
    ordinal: 53,
    migrationId: "052_session_review_state_filter.sql",
    checksum: "c322b6f27de5e2df26e030caa6a150322cc64ddbc1dee605cd88231d204a3377",
  },
  {
    ordinal: 54,
  ...
  {
    ordinal: 56,
    migrationId: "055_session_effects_and_mutation_receipts.sql",
    checksum: "57d8f97900911036a15713abf4b9469552e9edbca7540a9f7571745fba7c53e9",
  },
] as const;
...
export async function assertRuntimeSchemaReady(sql: SqlClient): Promise<void> {
  ...
  try {
    rows = await sql<AppliedMigrationRow[]>`
      ...
      WHERE ordinal BETWEEN 45 AND 56
      ORDER BY ordinal
    `;
  } catch (error) {
    throw new Error(
