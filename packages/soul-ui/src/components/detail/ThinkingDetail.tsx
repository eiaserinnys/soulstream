...
import type { ThinkingNode, TextNode } from "@shared/types";

export function ThinkingDetail({ card }: { card: ThinkingNode | TextNode }) {
  return (
    <div className="p-4 flex flex-col gap-3">
      ...
      <div className="flex items-center gap-2">
        ...
        {!card.completed && (
          <span className="ml-auto flex items-center gap-1.5 text-xs text-accent-purple">
