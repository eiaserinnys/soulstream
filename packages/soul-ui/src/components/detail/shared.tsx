...
export function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <div className="text-xs text-muted-foreground uppercase tracking-[0.05em] mb-1">
      {children}
    </div>
  );
}
...
export function CodeBlock({
  ...
  return (
    <pre
      className={cn(
        "text-caption p-2.5 rounded-md overflow-auto m-0 whitespace-pre-wrap break-words font-mono",
        variant === "error"
