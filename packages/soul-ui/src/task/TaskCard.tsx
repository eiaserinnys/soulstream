...
export function TaskCard({
  ...
  return (
    ...
    >
        ...
        <div className="flex min-w-0 items-start gap-2">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className={cn(
              ...
              <span data-testid="task-card-progress">
          ...
          {onOpenBoard ? (
            <DashboardIconCap
              label={`${title} 업무 보드 열기`}
              data-testid="task-card-open-board"
              className="shrink-0"
      ...
      <div data-testid="task-card-scroll" className="min-h-0 flex-1 overflow-y-auto px-4 py-4">
        {loading && !snapshot && (
