...
export function TaskOverviewRunningSessions() {
  ...
  return (
    <section data-testid="task-overview-running-sessions" className="min-w-0">
      ...
      {runningSessions.length > 0 ? (
        <div
          data-testid="task-overview-running-sessions-rail"
