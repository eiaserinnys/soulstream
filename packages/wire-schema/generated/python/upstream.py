...
# 노드 ↔ 오케스트레이터 WebSocket 메시지 정본. 127개 $defs (wire 66 + SSE event 61). 출처: soul-server-ts/src/upstream/* · packages/wire-schema generated SSE types + OpenAI Agents SDK parity.
#
