-- 011: Add caller_session_id to session_list_summary return columns
-- Part of caller-info cleanup: expose caller_session_id in list summary
-- so that frontends can display parent-session links without a separate query.
