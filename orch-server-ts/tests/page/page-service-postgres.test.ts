  ...
  it("does not change the live document when the database commit fails", async () => {
    const failing = new PageYjsService({
      repository: {
        ...
        searchBrowserPages: repository.searchBrowserPages.bind(repository),
        searchBrowserBlocks: repository.searchBrowserBlocks.bind(repository),
        getBrowserBlock: repository.getBrowserBlock.bind(repository),
        getBrowserBacklinks: repository.getBrowserBacklinks.bind(repository),
